    ...
    try {
        ...
        if (STATE === 'STOP') {
            ...
            if (marketClosed) {
                ...
                const absChangePercent = toFixedNumber((((sellPrice * ORDER_LOT) - ACCOUNT_VALUE) / ACCOUNT_VALUE) * 100);
            ...
            const absChangePercent = toFixedNumber((((lp * ORDER_LOT) - ACCOUNT_VALUE) / ACCOUNT_VALUE) * 100);
