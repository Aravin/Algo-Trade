...
| **Bot Controller Hook**      | App-root trading loop, live arming, degraded exits, state sync  | [`src/hooks/useStrategyBot.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/hooks/useStrategyBot.ts)         |
| **Trade Execution Hook**     | Entry/exit dispatch, exchange lot sizes, paper reconciliation   | [`src/hooks/useTradeExecution.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/hooks/useTradeExecution.ts)   |
| **Worker Router**            | Edge router, API dispatch, native request rate limiting         | [`worker/index.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/worker/index.ts)                                 |
...
| **Worker Bindings**          | Generated Cloudflare environment and runtime types              | [`worker-configuration.d.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/worker-configuration.d.ts)             |
...
| **`StrategyHeaderBar`**       | Persistent execution controls and supervision warnings  | [`src/components/dashboard/strategy/strategy-header-bar.tsx`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/components/dashboard/strategy/strategy-header-bar.tsx)   |
...
| `useStrategyBot.test.ts`       | Stop, abort, live arming, persisted supervision | [`src/hooks/__tests__/useStrategyBot.test.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/hooks/__tests__/useStrategyBot.test.ts)                                                             |
| `useTradeExecution.test.ts`    | Exit dispatch and terminal paper error codes    | [`src/hooks/__tests__/useTradeExecution.test.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/hooks/__tests__/useTradeExecution.test.ts)                                                       |
| `workerAuth.test.ts`           | Worker Auth0 fail-closed behavior               | [`src/lib/__tests__/workerAuth.test.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/lib/__tests__/workerAuth.test.ts)                                                                         |
| `workerRateLimit.test.ts`      | Native Worker binding and preflight behavior    | [`src/lib/__tests__/workerRateLimit.test.ts`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/lib/__tests__/workerRateLimit.test.ts)                                                               |
| `strategy-header-bar.test.tsx` | Stopped-position supervision warning            | [`src/components/dashboard/strategy/__tests__/strategy-header-bar.test.tsx`](file:///Users/aravind_appadurai/personal-projects/Algo-Trade/app/client/src/components/dashboard/strategy/__tests__/strategy-header-bar.test.tsx) |
