...
export const getRSISignal = (rsi: number, overboughtThreshold: number = 70, oversoldThreshold: number = 30): string => {
...
export const getRSISignalWithPosition = (rsi: number,
    positionType: string,
    overboughtThreshold: number = 70,
    oversoldThreshold: number = 30): string => {

    const generalSignal = getRSISignal(rsi, overboughtThreshold, oversoldThreshold);
